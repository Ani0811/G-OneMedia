    ...
    packages: [
      ...
      },
      {
        ...
        features: [
          ...
          'Dynamic Website Functionality & CMS',
          ...
          >
            {paginatedPackages.map((plan) => (
              <motion.div
                ...
                className={`glass-card p-8 lg:p-10 relative overflow-hidden flex flex-col justify-between group transition-all duration-300 h-full rounded-3xl ${
              ...
              >
                ...
                <div className="relative z-10 grow flex flex-col">
                  ...
                  <div className="flex items-center justify-between gap-2 mb-6">
                    <span className="inline-block px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-[10px] font-black text-cyan-400 uppercase tracking-widest">
                      {plan.name}
                    </span>
                  ...
                  <div className="flex flex-col mb-3 min-h-[72px] justify-end">
                    ...
                    >
                      <span className="text-4xl lg:text-5xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-teal-200 to-cyan-300 drop-shadow-[0_0_20px_rgba(0,240,255,0.45)] group-hover:scale-105 transition-transform duration-300 inline-block">
                        {plan.price?.[currency]}
                      </span>
                    </motion.div>
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-sm mb-8 font-medium text-[var(--text-secondary)] min-h-[44px]">
                    {plan.description}
                  </p>
                  ...
                  <div className="space-y-3.5 mb-10 grow">
                    {(plan.features || []).map((feature, idx) => (
                      <div key={`${feature}-${idx}`} className="flex items-center gap-3 text-sm text-[var(--text-secondary)]">
                        <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 bg-cyan-500/20 text-cyan-400 group-hover:bg-cyan-500/30 transition-colors">
                          <Check size={12} />
                        </div>
