          ...
          {projects.map((project, idx) => {
            ...
            return (
              <motion.a
                ...
                className="group block rounded-3xl p-5 bg-white/[0.02] border border-white/5 hover:border-cyan-500/30 hover:bg-white/[0.04] transition-all duration-300 relative"
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ExternalLink size={14} className="text-[var(--text-muted)] group-hover:text-cyan-400 transition-colors" />
                  </div>
